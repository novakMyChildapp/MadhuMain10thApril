...
import {StudentParentPasswordForgotRecovery} from '../actions/actions'


class ForgotStudentParentPassword extends React.Component{
	state={
		email:"",
...
// debugger
		...
		if(isValid){
			...
			this.props.StudentParentPasswordForgotRecovery({email}).then(
		...
		return(
			<div>
			    ...
			    <div className="welcome-list-head">
					<h1>Welcome To Student Password Recovery Page</h1>
				</div>
				<br/>
				            ...
				            <div className="row">                
				                ...
				                <div className="col-md-7 col-md-offset-3 form_register">
				                    ...
				                    <div className="Form_tab">
				                        <ul className="nav nav-tabs f_p">
				                            <li className="active"><a data-toggle="tab" href="#school">Student Password Recovery</a></li>
				                        </ul>
				                        ...
				                        <div className="tab-content">
				                            <div  className="tab-pane fade in active">
				                                <form onSubmit={this.handleSubmit}>
													...
													{ this.state.shouldRedirect ? <Redirect to={{pathname:"/", state:{StudentParent:this.state.successMessage}}} /> : "" }
				                                    ...
				                                    <button className="forgot_pass btn Btn_common"><i className="fa fa-paper-plane-o" aria-hidden="true"></i>Send Me A New Password</button>
...
export default connect(null, {StudentParentPasswordForgotRecovery}) (ForgotStudentParentPassword)