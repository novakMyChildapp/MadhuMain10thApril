...
class SchoolStudentProfileView extends React.Component{
	...
	handleChange = (e)=>{
		...
		if(this.state.slname === "" || this.state.slname === undefined) errors.slname="Last Name Can't Be Empty"
		if(this.state.sclass === "" || this.state.sclass === undefined) errors.sclass="Class Can't Be Empty"
		if(this.state.sGaurdianName === ""|| this.state.sGaurdianName === undefined) errors.sGaurdianName="Parent's/ Gaurdian's Name Can't Be Empty"
		if(this.state.sParentsPhonNumber === ""|| this.state.sParentsPhonNumber === undefined) errors.sParentsPhonNumber="Parent's/ Gaurdian's Phone Number Can't Be Empty"
		if(this.state.saddress === ""|| this.state.saddress === undefined) errors.saddress="Parent's / Gaurdians's Address Can't Be Empty"
				                ...
				                <div className="col-md-12 form_register">
									...
									<div className="form_main_stru2">
										...
										<div className="profile_pic">
											{this.state.studentImage && this.state.studentImage!=null ?<img src={this.state.studentImage} alt="Student Profile" />:<img src="http://images.parents.mdpcdn.com/sites/parents.com/files/styles/width_200/public/images/p_101687375.jpg" alt="Parent" />}
										</div>
											<div className="profile_data">
												...
												<button className="popup_o btn Btn_common"><i className="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button>
											</div>
										</div>
