...
var myStudentlist=(
	...
	{this.props.data.studentsArray && this.props.data.studentsArray!==undefined && this.props.data.studentsArray!==null && this.props.data.studentsArray.map((mystudents,i) => { return (<div className="Boxed col-lg-3 col-md-3 col-sm-6 col-xs-12">
					  		<div className="card">
					  			{mystudents.studentImage && mystudents.studentImage!==null ?<img className="card-img-top" src={mystudents.studentImage} alt="Student Profile" />:<img style={{"max-width":70+"%"}} className="card-img-top" src="https://rajeshindia-production.s3.amazonaws.com/uploads/management/image/3/Dummy_Image_Man.jpg" alt="Card"/>}
      				...
      				<div className="container teacher-view-detail">
	      				<div className="col-lg-4 col-md-4 col-sm-12 col-xs-12">
							<div className="card Boxed" style={{width: 30+ 'rem', float:"left", "marginLeft":20+"px", marginRight:20+"px", maxHeight:500+"px"}}>
						   		{this.props.data.teacherImage && this.props.data.teacherImage!=null ? <img src={this.props.data.teacherImage} alt="Teacher Profile" />:<img style={{width:50+"%"}} className="card-img-top" src="https://rajeshindia-production.s3.amazonaws.com/uploads/management/image/3/Dummy_Image_Man.jpg" alt="Card"/>}
						       	...
						       	<div className="card-block">
							 	    ...
							 	    {/*<Link to={{pathname:"/view/teachers/"+this.props.data._id+"/profile", state:{s:this.props.allstates}}} >
	       							...
	       							<div className="col-lg-8 col-md-8 col-sm-12 col-xs-12 Update_teacher">
...
// debugger
      return (
						...
						<div className="Boxed col-lg-3 col-md-3 col-sm-6 col-xs-12">
					  		<div className="card">
