      ...
      return (
							...
							<Link to={{pathname:"/view/teachers/"+teachers.temail, state:{s:main}}}>
								<div className="col-md-3 col-sm-4 col-xs-12">
							  		<div className="card">
							  			{teachers.teacherImage && teachers.teacherImage!=null ?<img className="card-img-top" src={teachers.teacherImage} alt="Teacher Profile" />:<img style={{width:85+"%"}} className="card-img-top" src="https://rajeshindia-production.s3.amazonaws.com/uploads/management/image/3/Dummy_Image_Man.jpg" alt="Card"/>}
