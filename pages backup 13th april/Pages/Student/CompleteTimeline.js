					...
					<div className="well">
				      <div className="media">
					      	<a className="pull-left" href="#">
					    		{this.props.data.teacherImage && this.props.data.teacherImage!==null && this.props.data.teacherImage!==undefined?<img className="media-object" alt="Profile" src={this.props.data.teacherImage} />:<img className="media-object" alt="Profile" src="http://placekitten.com/150/150" />}
					  		</a>
