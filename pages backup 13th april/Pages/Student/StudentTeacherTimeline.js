...
import { FetchMyPosts, logMeOut } from '../../actions/StudentActions'
...
teacherImage:'',
	...
	render(){
		...
		const PostContainer=(
				<div>
				<div className="welcome-list-head"><h1>All Posts {"From "+ this.props.params.id}</h1></div>
				<br/>
...
export default connect(null, {FetchMyPosts,logMeOut}) (StudentTeacherTimeline)