							...
							<div className="posts-in">
								<div className="teacher-sec">
									<div className="teacher-pro">
										 ...
										 {this.state.teacherImage && this.state.teacherImage!=null?<img src={this.state.teacherImage} alt="Tacher Profile" className="img-responsive" />:<img src="http://139.59.7.53:3001/Teachermain1.jpg" alt="Main" className="img-responsive"/>}
									</div>
								...
								<div className="student-sec">
									<div className="student-pro">
										{this.state.studentImage && this.state.studentImage!=null ?<img src={this.state.studentImage} alt="Student Profile" />:<img src="/stu2.jpg" alt="Main" className="img-responsive"/>}
									</div>
