...
import {SchoolPasswordForgotRecovery} from '../actions/actions'


class ForgotSchoolPassword extends React.Component{
	state={
		email:"",
...
// debugger
		...
		if(isValid){
			...
			this.props.SchoolPasswordForgotRecovery({email}).then(
		...
		return(
			<div>
			    ...
			    <div className="welcome-list-head">
					<h1>Welcome To School Password Recovery Page</h1>
				</div>
				<br/>
				                        ...
				                        <div className="tab-content">
				                            <div  className="tab-pane fade in active">
				                                <form onSubmit={this.handleSubmit}>
													...
													{ this.state.shouldRedirect ? <Redirect to={{pathname:"/", state:{school:this.state.successMessage}}} /> : "" }
...
export default connect(null, {SchoolPasswordForgotRecovery}) (ForgotSchoolPassword)