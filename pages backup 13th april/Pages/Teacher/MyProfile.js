...
class MyTeacherProfile extends React.Component{
	...
	handleSubmit = (e)=>{
		...
		if(this.state.tlname === "") errors.tlname="Name Can't Be Empty" 
			//qualifications can be empty
		if(this.state.tsubject === "") errors.tsubject="Subject/ Speciality Can't Be Empty"
		if(this.state.tphoneNumber === "") errors.tphoneNumber="Phone Number Can't Be Empty"
		if(this.state.taddress === "") errors.taddress="Address Can't Be Empty"


		if(this.state.tpassword ==="") errors.tpassword="Password Can't Be Empty"
				                        ...
				                        <div className="tab-content">
				                            <div  className="tab-pane fade in active">
				                                <form onSubmit={this.handleSubmit}>
				                                    ...
				                                    {this.state.teacherImage && this.state.teacherImage!==null?<img src={this.state.teacherImage} alt=""/> : <img src="https://rajeshindia-production.s3.amazonaws.com/uploads/management/image/3/Dummy_Image_Man.jpg" alt="" />}
