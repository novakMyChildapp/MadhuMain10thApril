...
import {FetchTheStudentsPosts, saveTeacherPostOnStudent,uploadImage, logMeOut} from '../../actions/TeacherActions'
...
// debugger
			...
			const isValid = Object.keys(errors).length===0
				...
				if(isValid){
					...
					.then(data => { console.log(data);this.setState({loading:false, done:true, shouldRedirect:true,headline:"", description:""}); window.location.reload(true)})
						...
						<div className="well">
					      <div className="media">
						      	<a className="pull-left profile_img" href="#">
						    		{this.props.s.teacherImage && this.props.s.teacherImage!=null ? <img src={this.props.s.teacherImage} alt="TeacherProfile" />:<img className="media-object" src="https://rajeshindia-production.s3.amazonaws.com/uploads/management/image/3/Dummy_Image_Man.jpg" alt="Profile" />}
						  		</a>
...
export default connect (null, {FetchTheStudentsPosts, saveTeacherPostOnStudent, uploadImage, logMeOut}) (TeacherStudentTimeline)