					...
					<div>
						...
						<div className="container">
							...
							<div className="teacher-pro">
								 ...
								 {this.state.teacherImage && this.state.teacherImage!=null ? <img src={this.state.teacherImage} alt="Teacher Profile" />:<img src="/Teachermain1.jpg" alt="Main" className="img-responsive"/>}
							</div>
