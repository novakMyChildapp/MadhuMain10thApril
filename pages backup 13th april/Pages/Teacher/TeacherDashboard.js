   ...
   render() {
      return (
				...
				<div className="Boxed col-md-3 col-sm-4 col-xs-12">
					<div className="card">
				  		{this.props.data.studentImage && this.props.data.studentImage!==null ? <img src={this.props.data.studentImage} alt="Student Profile"/>:<img className="card-img-top" src="https://rajeshindia-production.s3.amazonaws.com/uploads/management/image/3/Dummy_Image_Man.jpg" alt="Card"/>}
