				                        ...
				                        <div className="tab-content">
				                            ...
				                            <div id="teacher" className="tab-pane fade">
				                                <form onSubmit={this.handleSubmitTeacher}>
				                                    ...
				                                    <p className="fa fa-star"><div className={classnames('form-group', {"has-error":!!this.state.errors.tpassword})}> <input type="password" className="form-control input-lg" name="tpassword" id="tpassword" value={this.state.tpassword} onChange={this.handleChange} placeholder="Enter email" /><span className="errorM">{this.state.errors.tpassword} </span></div></p>
				                                    <a href="#">Forget password?</a>
				                                    <button><i className="fa fa-paper-plane-o" aria-hidden="true"></i> Sign In</button>
				                                </form>
				                            </div>
				                            ...
				                            <div id="parent" className="tab-pane fade">
				                                <form onSubmit={this.handleSubmitStudent}>
				                                    ...
				                                    <p className="fa fa-star"><div className={classnames('form-group', {"has-error":!!this.state.errors.spassword})}> <input type="password" className="form-control input-lg" name="spassword" id="spassword" value={this.state.spassword} onChange={this.handleChange} placeholder="Enter email" /><span className="errorM">{this.state.errors.spassword} </span></div></p>
				                                    <a href="#">Forget password?</a>
				                                    <button><i className="fa fa-paper-plane-o" aria-hidden="true"></i> Sign In</button>
				                                </form>
				                            </div>
