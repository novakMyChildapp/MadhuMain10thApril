				                                ...
				                                <form onSubmit={this.handleSubmit}>
				                                   ...
				                                   <div className="row">
				                                    <div className="profile_img_left_st_pr col-md-3">
				                                    	{this.state.studentImage && this.state.studentImage!==null ? <img src={this.state.studentImage} alt="Student Profile" />: <img src="/Dummy_Image_Man.jpg" alt="No Profile Image" />}
