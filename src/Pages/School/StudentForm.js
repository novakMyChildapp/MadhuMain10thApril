...
class StudentForm extends React.Component{
	...
	handleSubmit = (e)=>{
		...
		if(this.state.sname === "" || this.state.sname.trim() === "") errors.sname="Name Can't Be Empty"

		if(this.state.slname === "" || this.state.slname.trim() === "") errors.slname="Last Name Can't Be Empty"

		if(this.state.sclass === "" || this.state.sclass.trim() === "") errors.sclass="Class Can't Be Empty"
		...
		if(this.state.sGaurdianName === "" || this.state.sGaurdianName.trim() === "") errors.sGaurdianName="Parent's/ Gaurdian's Name Can't Be Empty"
...
// console.log("2*** "+this.state.sParentsPhonNumber.length)
		if(this.state.saddress === "" || this.state.saddress.trim() === "") errors.saddress="Parent's / Gaurdians's Address Can't Be Empty"
												...
												<div  className="tab-pane fade in active">
													<form onSubmit={this.handleSubmit}>
														...
														<div className="form_group">	
															<p className="fa fa-user"> <div className={classnames('form-group', {"has-error":!!this.state.errors.semail})}> <input type="email" className="form-control input-lg" name="semail" id="semail" value={this.state.semail} onChange={this.handleChange} placeholder="Enter Parents email" /><span className="errorM">{this.state.errors.semail} </span></div></p>
														...
														<div className="form_group">
															...
															<p className="fa fa-user"> <div className={classnames('form-group', {"has-error":!!this.state.errors.sParentsPhonNumber})}> <input type="number" className="form-control input-lg" name="sParentsPhonNumber" id="sParentsPhonNumber" value={this.state.sParentsPhonNumber} onChange={this.handleChange} placeholder="Enter Parent/Gaurdian Phone No." /><span className="errorM">{this.state.errors.sParentsPhonNumber} </span></div></p>
														</div>
