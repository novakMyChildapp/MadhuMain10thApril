							...
							.then(
								(response)=>{ debugger;this.setState({done:true}) ;console.log("%%%%%"); console.log(response)
									if(response.errorMessage && response.errorMessage!==undefined && response.errorMessage!==null && response.errorMessage!=='' && response.success===null){
										...
										this.setState({loading:false, done:true, shouldRedirect:true, SuccessMessageOnAssignment:"Successfully Deleted"})
				...
				.then(
					(response)=>{ debugger ; this.setState({done:true}) ;console.log("%%%%%"); console.log(response)
						if(response.errorMessage && response.errorMessage!==undefined && response.errorMessage!==null && response.errorMessage!=='' && (response.success===null || response.success===undefined)){
							...
							debugger;
							this.setState({loading:false, done:true, StudentList:response.students, SuccessMessageOnAssignment:"Successfully Added"})
							console.log("HHHHHHHHHHHHHHHHHHHHHHEEEEEEEEEEEEEEEEEERRRRRRRRRRRRREEEEEEEEEEEEEE")
							console.log(this.state)
							window.location.reload(true)
						}
							...
							.then(
								(response)=>{this.setState({done:true}) ;console.log("%%%%%"); console.log(response)
									if(response.errorMessage && response.errorMessage!==undefined && response.errorMessage!==null && response.errorMessage!=='' && response.success===null){
										...
										this.setState({loading:false, done:true, SuccessMessageOnAssignment:"Successfully Un Assigned"})
										console.log("HHHHHHHHHHHHHHHHHHHHHHEEEEEEEEEEEEEEEEEERRRRRRRRRRRRREEEEEEEEEEEEEE")
										console.log(this.state)
										window.location.reload(true)
									}
					...
					<div className="teacher-view-wrap">
						...
						{console.log(this.state)}
							...
							<div className="added-students-list">
								...
								{this.state.SuccessMessageOnAssignment && this.state.SuccessMessageOnAssignment!==null &&  this.state.SuccessMessageOnAssignment!==undefined && this.state.SuccessMessageOnAssignment!=="" && <div id="#warning" className="alert alert-success">{this.state.SuccessMessageOnAssignment}</div>}
											...
											<div className="tab-content">
												<div  className="tab-pane fade in active">
													<form onSubmit={this.props.handleSubmit}>
														...
														<div className="form_group child_ele  clear-pro">	
