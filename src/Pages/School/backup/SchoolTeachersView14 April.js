...
var myStudentlist=(
	...
	{this.props.data.studentsArray && this.props.data.studentsArray!==undefined && this.props.data.studentsArray!==null && this.props.data.studentsArray.map((mystudents,i) => { return (<div className="Boxed col-lg-3 col-md-3 col-sm-3 col-xs-12">
					  		<div className="card">
...
// debugger
      return (
						...
						<div className="Boxed col-lg-3 col-md-3 col-sm-3 col-xs-12">
					  		<div className="card">
