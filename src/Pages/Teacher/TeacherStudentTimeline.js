					      ...
					      <div className="media">
								...
								{ this.props.s.shouldRedirect ? reloadme:"" }
								  ...
								  <div className="containerTimeline">
									...
									<textarea className="timelineInput" type="text" name="comment" /*value={this.props.s.comment}*/ onChange={this.props.handleChangeC} id="comment" placeholder="Comment here"></textarea>
